...
st.set_page_config(
    page_title="AI ECG Chẩn Đoán",
    page_icon="🫀",
    layout="wide"
)

st.title("🫀 AI Chẩn Đoán ECG")
st.caption("Chuẩn hóa nhịp tim trên DII kéo dài; Bổ sung bảng nhập thông số Phì đại buồng tim (Lớn nhĩ & Dày thất)")
...
# =========================================================================
# 1. TIỀN XỬ LÝ ẢNH & BÓC TÁCH TÍN HIỆU
# =========================================================================
...
class ECGClinicalAnalyzer:
    ...
    def evaluate_hypertrophy(self):
        ...
        # ---------------- LỚN NHĨ (ƯU TIÊN GHI ĐÈ THỦ CÔNG) ----------------
        m_atrial = self.manual_override.get("atrial_override", "Tự động")
        if m_atrial == "Lớn nhĩ phải (P phế)":
            self.findings.append(("Lớn buồng tim", "Lớn nhĩ phải (P phế): Sóng P cao ≥ 2.5 mm ở DII/DIII/aVF"))[cite: 5]
        elif m_atrial == "Lớn nhĩ trái (P nhĩ)":
            self.findings.append(("Lớn buồng tim", "Lớn nhĩ trái (P nhĩ): Sóng P ở DII dạng 2 đỉnh rộng > 0.11s, pha âm ở V1 rộng > 0.04s và sâu > 1 mm"))[cite: 5]
        elif m_atrial == "Lớn hai nhĩ":
            self.findings.append(("Lớn buồng tim", "Lớn hai nhĩ: Sóng P vừa cao ≥ 2.5 mm vừa rộng ≥ 0.12s ở DII"))[cite: 5]
        ...
        # ---------------- DÀY THẤT (SOKOLOW-LYON, CORNELL, KATZ-WACHTEL, ROMHILT-ESTES) ----------------
...
with col1:
    ...
    if use_manual_override:
        ...
        # BỔ SUNG MỤC ĐÁNH GIÁ LỚN NHĨ & DÀY THẤT CHUYÊN SÂU
